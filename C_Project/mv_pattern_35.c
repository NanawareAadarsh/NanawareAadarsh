...
_______|_____________________________
   ...
   ALGORITHAM:-
          ...
          3) ile is start from = 1 and end at <=ole*2-1to printing the numbers
          
          5)after ile loop we are decrementing the number as 
          number = number-1 to print new number
...
{
printf("   ");  // orinting the space
}
} 
number = number+1; // here we are printg the number as number-1 ine next row
